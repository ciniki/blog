...
//        '_images':{'label':'', 'type':'simplegrid', 'num_cols':1,
            'addTopTxt':'Add Additional Image',
            'addTopFn':'M.startApp(\'ciniki.blog.postimages\',null,\'M.ciniki_blog_post.post.open();\',\'mc\',{\'post_id\':M.ciniki_blog_post.post.post_id,\'add\':\'yes\'});',
            },
