...
// -------
//
function ciniki_blog_wng_postLoad($ciniki, $tnid, $request, $post_permalink) {
    ...
    $strsql = "SELECT ciniki_blog_posts.id, "
        ...
        . "AND (ciniki_blog_posts.publish_to&0x01) = 0x01 " // Public
        . "";
    ...
    //
    if( ciniki_core_checkModuleFlags($ciniki, 'ciniki.blog', 0x03) ) {
