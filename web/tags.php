...
function ciniki_blog_web_tags($ciniki, $settings, $business_id, $tag_type, $blogtype) {
	...
	$strsql = "SELECT ciniki_blog_post_tags.tag_name, "
		...
		. "AND ciniki_blog_post_tags.tag_type = '" . ciniki_core_dbQuote($ciniki, $tag_type) . "' "
	...
	$strsql .= "GROUP BY ciniki_blog_post_tags.tag_name "
		. "ORDER BY ciniki_blog_post_tags.tag_name, ciniki_blog_posts.primary_image_id ASC, ciniki_blog_posts.date_added DESC "
		. "";
