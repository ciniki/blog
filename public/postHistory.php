...
//  </users>
//
function ciniki_blog_postHistory($ciniki) {
    //
    ...
    $rc = ciniki_blog_checkAccess($ciniki, $args['tnid'], 'ciniki.blog.postHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    if( $args['field'] == 'publish_date' ) {
        ...
        return ciniki_core_dbGetModuleHistoryReformat($ciniki, 'ciniki.blog', 'ciniki_blog_history', 
            $args['tnid'], 'ciniki_blog_posts', $args['post_id'], $args['field'], 'utcdatetime');
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.blog', 'ciniki_blog_history', 
        $args['tnid'], 'ciniki_blog_posts', $args['post_id'], $args['field']);
}
?>
