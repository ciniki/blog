...
function ciniki_blog_settingsUpdate(&$ciniki) {
    ...
    $rc = ciniki_blog_checkAccess($ciniki, $args['business_id'], 'ciniki.blog.settingsUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    foreach($changelog_fields as $field) {
        if( isset($ciniki['request']['args'][$field]) 
            ...
            $strsql = "INSERT INTO ciniki_blog_settings (business_id, detail_key, detail_value, date_added, last_updated) "
            ...
            ciniki_core_dbAddModuleHistory($ciniki, 'ciniki.blog', 'ciniki_blog_history', $args['business_id'], 
