...
// Description
// ===========
// This method will remove an existing image from a blog post.
//
// Arguments
// ---------
// 
...
// <rsp stat='ok' />
//
function ciniki_blog_postImageDelete(&$ciniki) {
    //  
    ...
    $rc = ciniki_blog_checkAccess($ciniki, $args['business_id'], 'ciniki.blog.postImageDelete'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
